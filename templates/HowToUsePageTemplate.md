...
- **Art Work Map** : last of all, all of the maps for the tour will need to be remade to include the new artpiece (unless the new art piece is in the exact same location as another artpiece then you can skip this step) to do this you will need to _____ TODO . this should be placed in the /resources/images/maps folder and named,,,,,
